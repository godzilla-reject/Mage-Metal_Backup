...
columns:
  ...
  Tags:
    ...
    sortIndex: -1
    options:
      - { label: "Frame", value: "Frame", color: "hsl(179, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Class:
    ...
    sortIndex: -1
    options:
      - { label: "Ultralight", value: "Ultralight", color: "hsl(129, 95%, 90%)"}
...
config:
  ...
  current_row_template: Templates/Markdown Templates/Metal Templates/Frame Template.md
  pagination_size: 10
  font_size: 16
